        ...
        <div className="mb-16 grid gap-6 sm:grid-cols-3">
          {modularPrinciples.map((principle, i) => (
            <ScrollReveal
              key={principle.title}
              delay={i * 0.1}
              className="group rounded-2xl border border-white/10 bg-white/[0.03] p-7 backdrop-blur-sm transition-all duration-300 hover:border-forge-amber/30 hover:bg-white/[0.06]"
            >
